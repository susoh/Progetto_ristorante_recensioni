...
--
-- Host: 127.0.0.1
-- Creato il: Mag 22, 2025 alle 10:12
...
(2, 5, '2025-05-15 07:39:37', 11, 'ris2'),
(3, 2, '2025-05-15 08:01:36', 11, 'ris1'),
(4, 5, '2025-05-15 08:11:07', 5, 'ris4'),
(5, 4, '2025-05-15 08:12:53', 22, 'ris2'),
(6, 2, '2025-05-15 08:12:58', 22, 'ris3'),
(7, 2, '2025-05-15 08:13:04', 22, 'ris4');
...
CREATE TABLE `ristorante` (
  ...
  `latitudine` double DEFAULT 43.7800127,
  `longitudine` double DEFAULT 11.1997685
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('ris1', 'Il bubolo antico', 'Via del pongo 23', 'Firenze', 43.7800127, 11.1997685),
('ris2', 'Il cantinone', 'Via di Leon 63', 'Firenze', 43.7800127, 11.1997685),
('ris3', 'Ciardo', 'Via roma 10', 'Milano', 43.7800127, 11.1997685),
('ris4', 'BombiniCusini', 'Via faenza 12', 'Cartonetta', 43.7800127, 11.1997685),
('ris5', 'Calamari e Trottole', 'Via Vicarello 95', 'Livorno', 43.7800127, 11.1997685),
('ris6', 'Skibidi', 'Via alpha 1', 'Golb', 43.959159, 12.882362);
...
(5, 'malenia', '8c2101cf54bcafc68385dd494735f93826ccc148cff1ffa9f4184db3b7e30737', ' malenia', ' miquella ', ' malenia.bladeof@miquella.er ', '2025-05-15 07:08:03', 1),
...
(22, 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'admin', 'admin', 'admin@admin.admin', '2025-05-15 08:13:29', 1);
